...
def modify(frame, data):
    ...
    dip_len[com_as_particle_index]=[1,0,0] #value of the dipole that will be rendered only at the com particle
    ...
    dip_vel[com_as_particle_index]=[0,1,0] #value of the dipole that will be rendered only at the com particle
    ...
    mag[com_as_particle_index]=[0,0,1] #value of the dipole that will be rendered only at the com particle
