...
mixmoments=np.zeros(shape=(nroots,nroots,ndir)) #3D array with all moments of all directions
...
for i in range(ndir):
    ...
    file1.writelines([str(directions[i,0])," ",str(directions[i,1])," ",str(directions[i,2]), " ", str(velmoments[ri-1,rf-1,i]), " ", str(velmoments_cgs[ri-1,rf-1,i]), "\n"])
    file2.writelines([str(directions[i,0])," ",str(directions[i,1])," ",str(directions[i,2]), " ", str(mixmoments[ri-1,rf-1,i]), " ", str(mixmoments_cgs[ri-1,rf-1,i]), "\n"])
